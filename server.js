...
// ── Sert CamIA directement depuis la racine ──
app.get('/app', (_, res) => res.sendFile(path.join(__dirname, 'index-4.html')));
app.get('/camia', (_, res) => res.sendFile(path.join(__dirname, 'index-4.html')));
